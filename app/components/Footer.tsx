...
const Footer = () => {
    return (
        ...
        //     </section>
        // </footer>
        <footer className="relative mx-auto flex w-full flex-col flex-nowrap justify-center gap-3 bg-black px-6 pb-5 pt-20">
            <div className="flex flex-col flex-nowrap gap-6 py-6">
                ...
                <div className="flex flex-col font-serif text-5xl">
                    <span>✺</span>
                    <h2 className="text-neutral-100">Let's Collaborate</h2>
                </div>
                <div className="mt-5">
                    <h4 className="text-lg">bensoncraven@hotmail.co.uk</h4>
                </div>
            </div>
        </footer>
    )
